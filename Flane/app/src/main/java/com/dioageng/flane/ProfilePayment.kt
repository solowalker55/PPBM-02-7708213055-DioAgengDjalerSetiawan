...
class ProfilePayment : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val gotoprofile = findViewById<ImageView>(R.id.ppayment_profile)
        gotoprofile.setOnClickListener{
            val Intent = Intent(this, Profile::class.java)
            startActivity(Intent)
        }

        val gotonot = findViewById<LinearLayout>(R.id.ppayent_not)
